...
const Contact = () => {
    ...
    const [tip, setTip] = useState('Sending')
    const [copyTip, setCopyTip] = useState('Click to copy!')

    const handleSubmit = (e) => {
        e.preventDefault()
        console.log(fromEmail, fromName, message);
        setTip('Sending')
        setOpen(true)
    ...
    const handleCopy = () => {
        setCopyTip('Copied!')
        setTimeout(() => setCopyTip('Click to copy!'), 1000)
        navigator.clipboard.writeText('andykle@outlook.com')
    }
    ...
    return (
        ...
        <form style={{display: 'flex', flexDirection: 'column'}} onSubmit={handleSubmit}>
            <TextField 
                ...
                sx={{
                    input: {color: "#DADBDD"},
                    fieldset: { borderColor: "#4C4452"}, 
                    label: {color: "#DADBDD"},
                    ".MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline": { borderColor: "#4C4452"},
                    ".MuiOutlinedInput-root:hover .MuiOutlinedInput-notchedOutline": { borderColor: "#4C4452" }, 
                    ".MuiFormLabel-root.Mui-focused": {color: "#4C4452"}
                    }}
            />
            ...
            <Tooltip 
                ...
                <Button type='submit' style={{color: "#5F8DF7"}}>Submit</Button>
            </Tooltip>
        </form>
        </div>

        <Tooltip title={copyTip} onClick={() => handleCopy()}>
            <p style={{cursor: 'pointer'}}>andykle@outlook.com</p>
        </Tooltip>
        <div className='contacts'>
            <Tooltip title="Linkedin">
                <a href='https://www.linkedin.com/in/andy-le1/' style={{width: 35}}>
            ...
            <Tooltip title="Github">
                <a href='https://github.com/CausticCheetos' style={{width: 35}}>
                    <svg viewBox="0 0 128 128">
